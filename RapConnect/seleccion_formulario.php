...
<div class="centered-container">
    ...
    <a href="formulario/modificar_rapero.php" class="btn btn-warning" role="button">Modificar un Rapero</a>
    <a href="formulario/" class="btn btn-danger" role="button">Eliminar Rapero</a>
</div>
